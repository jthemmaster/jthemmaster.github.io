...
const sizeMap = {
  sm: { icon: 'h-9 w-9 rounded-xl', text: 'text-sm', dot: 'h-2.5 w-2.5', inset: 'inset-[8px]' },
  md: { icon: 'h-11 w-11 rounded-[14px]', text: 'text-base', dot: 'h-3 w-3', inset: 'inset-[9px]' },
  lg: { icon: 'h-14 w-14 rounded-[18px]', text: 'text-lg', dot: 'h-3.5 w-3.5', inset: 'inset-[11px]' },
}
    ...
    <div className="flex items-center gap-3">
      <div
        className={`
          ...
          shadow-[0_10px_24px_rgba(0,0,0,0.18)] ${icon}
        `}
      >
        <div className={`absolute ${inset} rounded-[10px] border border-white/10 bg-white/[0.02]`} />
